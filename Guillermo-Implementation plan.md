...
**Daily Discrepancy Report:** Generated at 6:00 AM MST, delivered via Discord and archived to the Git repository.
...
Generated at 6:00 AM MST. Delivered via Discord (`#compliance-reports` channel) and committed to the private backup Git repository.
...
| Setting | Value |
|---------|-------|
| Bot Name | Atlas (distinct from "Jarvis" main assistant) |
...
> 8. Configure daily report generation at 6:00 AM MST → post to `#compliance-reports` on Discord and commit to backup repo
...
| Daily report timing | 6:00 AM MST | Catch overnight drift before workday |
